...
<?php require('./Layouts/header.php')?>
    ...
    <div id="nuevo-contenedor-gris-small">
        ...
        <div id="contenedor-horizontal">
            ...
            <a id="enlace-derecho" href="obras.php">ver todas las obras</a>
        </div>
  ...
  <div class="photo">
    ...
    <div id="texto-centrado">Muestra tu arte al mundo</div>
    <div id="contenedor-espacio"></div>
    <div id="boton-centrado">
        <a href="contactanos.php"><button id="cambiar-color">Contactanos</button></a>
    </div>
    </div>
